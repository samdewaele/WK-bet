...
// Extract 2-letter ISO country code from a flag emoji (e.g. 🇧🇪 → "BE")
export function flagToCode(flag: string): string {
  ...
  if (flag.includes('\u{E0065}\u{E006E}\u{E0067}')) return 'EN';
  if (flag.includes('\u{E0073}\u{E0063}\u{E0074}')) return 'SC';
  if (flag.includes('\u{E0077}\u{E006C}\u{E0073}')) return 'WL';
  return '??';
}
